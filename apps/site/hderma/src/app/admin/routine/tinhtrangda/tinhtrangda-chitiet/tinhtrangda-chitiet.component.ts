...
@Component({
  selector: 'app-tinhtrangda-chitiet',
  templateUrl: './tinhtrangda-chitiet.component.html',
  styleUrls: ['./tinhtrangda-chitiet.component.css']
})
export class TinhtrangdaChitietComponent implements OnInit {
  Detail: any={}
  Danhmuc:any[] =[]
  Nhomroutine:any[] =[]
  ...
  constructor(
    ...
    private _TinhtrangdaComponent: TinhtrangdaComponent,
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe((paramsId) => {
      ...
      if (id) {
        this._TinhtrangdaComponent.drawer.open();
        this._TinhtrangdaService.getByid(id).subscribe();
        this._TinhtrangdaService.tinhtrangda$.subscribe((res:any) => {
          if (res) {
            console.log(res);    
            this.Detail = res;
          }
...
configTiny: EditorComponent['init'] = {
  ...
  CloseDrawer()
  {
    ...
    this._TinhtrangdaComponent.drawer.close();
  }
  Update(data:any)
  {
    this._TinhtrangdaService.updateTinhtrangda(data).subscribe((res) => {
      if (res) {
        this._TinhtrangdaComponent.ngOnInit()
