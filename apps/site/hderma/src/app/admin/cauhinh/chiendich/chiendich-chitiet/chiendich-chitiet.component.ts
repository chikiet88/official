...
@Component({
  selector: 'app-chiendich-chitiet',
  templateUrl: './chiendich-chitiet.component.html',
  styleUrls: ['./chiendich-chitiet.component.css']
})
export class ChiendichChitietComponent implements OnInit {
  displayedColumns: string[] = ['TenCD','Doanhthu', 'Noidung', 'Diem', 'Giatriqua'];
  dataSource!: MatTableDataSource<any>;
  ListChiendich:any[]=[];
  Hoahongs:any[]=[];
  Chiendich:any={Nhiemvus:[{idSP:'',Soluong:'',Deadline:''}],ListDiem:[],ListGiatriqua:[],ListMax:[],ListActive:[]};
  ChiendichInit:any={};
